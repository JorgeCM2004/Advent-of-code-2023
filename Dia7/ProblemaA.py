def classifier(card: str) -> str:
    ...
    generating_card = ''
    for i in card:
        if i in generating_card or generating_card == '':
...
def sort_camel(l: list) -> list:
    replaces = (('A', 'a'), ('K', 'b'), ('Q', 'c'), ('J', 'd'), ('T', 'e'), ('9', 'f'), ('8', 'g'), ('7', 'h'), ('6', 'i'), ('5', 'j'), ('4', 'k'), ('3', 'l'), ('2', 'm'))
...
if __name__ == '__main__':
    input_file_name = 'Dia7/ProblemaA_input.txt'
    output_file_name = 'Dia7/ProblemaA_output.txt'
